...
import { Card, Empty, Page, ScreenHead, ScoreBar, Tag } from "@/components/ui";
...
export default async function DecisionsPage() {
  ...
  return (
    <Page>
      <ScreenHead sub={address.label}>Decisions</ScreenHead>
      <ScaleSelector
              ...
              <li key={d.id}>
                <Card className={passed ? "border-calm/30" : ""}>
                  <div className="flex items-start justify-between gap-3">
                    <Link
                      href={`/collective/proposals/${d.proposal_id}`}
