...
import { Card, Empty, Page, ScreenHead, SectionLabel } from "@/components/ui";
...
export default async function ImpactPage() {
  ...
  return (
    <Page>
      <ScreenHead sub={address.label}>Impact</ScreenHead>
      <ScaleSelector
            ...
            {lessons.map((r) => (
              <li key={r.id}>
                <Card>
                  ...
                  {r.projects ? (
                    <Link
                      href={`/collective/projects/${r.projects.proposal_id}`}
